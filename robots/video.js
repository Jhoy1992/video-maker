...
async function robot() {
  ...
  async function createSentenceImage(sentenceIndex, sentenceText) {
    return new Promise((resolve, reject) => {
      ...
      console.log(`> [video-robot] Creating sentence: ${outputFile}`)
  ...
  async function renderVideoAfterEffects() {
    return new Promise((resolve, reject) => {
      const aerenderFilePath =
        "C:\\Program Files\\Adobe\\Adobe After Effects CC 2019\\Support Files\\aerender"
